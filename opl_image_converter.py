...
class OPLImageConverterApp:
    ...
    def _create_ui(self):
        ...
        preview_original_frame = ttk.LabelFrame(preview_container, text="Original")
        preview_original_frame.pack(side=tk.LEFT, fill=tk.BOTH, expand=True, padx=(0, 5))
        
        self.preview_original_label = ttk.Label(preview_original_frame)
    ...
    def _update_preview(self):
        ...
        if not self.input_files:
            ...
            self.preview_original_label.config(image="")
